...
export default ({show, setModalShow}) => (
        ...
        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div className="sm:flex sm:items-start">
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <h2 className="text-gray-500">React & Redux</h2>
              ...
              <div className="mt-2">
                ...
                <form class="w-full">
                  ...
                  <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-9/12">
                      <textarea className="w-full bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" placeholder="We build fine acmes." rows="4"></textarea>
                    </div>
                  </div>
                  <div class="md:flex md:items-center mb-6">
                    <div class="md:w-3/12">
                    ...
                    <div class="md:w-9/12">
                      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" value="https://janedoe.io" />
                    </div>
                  </div>
                </form>
